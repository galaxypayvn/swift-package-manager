#
#  Be sure to run `pod spec lint GalaxyPayPod.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/galaxypayvn/swift-package-manager.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "GalaxyPayPod/**/*.{h,m,swift}"
