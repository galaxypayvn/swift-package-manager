...
#ifndef GALAXYPAYSDK_SWIFT_H
#define GALAXYPAYSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GalaxyPaySDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12GalaxyPaySDK7BoxView")
...
SWIFT_CLASS("_TtC12GalaxyPaySDK4GPay")
@interface GPay : NSObject
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12GalaxyPaySDK14GradientButton")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12GalaxyPaySDK12GradientView")
...
SWIFT_CLASS("_TtC12GalaxyPaySDK15IQBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12GalaxyPaySDK28IQBarButtonItemConfiguration") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12GalaxyPaySDK12IQInvocation") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12GalaxyPaySDK17IQKeyboardManager") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
@interface IQKeyboardManager (SWIFT_EXTENSION(GalaxyPaySDK)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC12GalaxyPaySDK26IQKeyboardReturnKeyHandler") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(GalaxyPaySDK)) <UITextFieldDelegate>
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(GalaxyPaySDK)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC12GalaxyPaySDK18IQPreviousNextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12GalaxyPaySDK10IQTextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12GalaxyPaySDK20IQTitleBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12GalaxyPaySDK9IQToolbar") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS_NAMED("NotificationItem")
@interface NotificationItem : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end



@interface NotificationItem (SWIFT_EXTENSION(GalaxyPaySDK))
@property (nonatomic, copy) NSString * _Nullable action;
@property (nonatomic, copy) NSString * _Nullable actionDirect;
...
@property (nonatomic, copy) NSString * _Nullable extra_data;
...
@property (nonatomic, copy) NSString * _Nullable isStorage;
...
SWIFT_CLASS("_TtC12GalaxyPaySDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(GalaxyPaySDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(GalaxyPaySDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(GalaxyPaySDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(GalaxyPaySDK)) <NSURLSessionTaskDelegate>
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIImage (SWIFT_EXTENSION(GalaxyPaySDK))
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIScrollView (SWIFT_EXTENSION(GalaxyPaySDK))
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIView (SWIFT_EXTENSION(GalaxyPaySDK))
/// To set customized distance from keyboard for textField/textView. Can’t be less than zero
@property (nonatomic) CGFloat keyboardDistanceFromTextField;
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIViewController (SWIFT_EXTENSION(GalaxyPaySDK))
